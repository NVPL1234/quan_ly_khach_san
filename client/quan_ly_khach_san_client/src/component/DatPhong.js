    ...
    const themDSHDVaoBang = (dshd) => {
        ...
        for (let i = 0; i < dshd.length; i++) {
            ...
            buttonCT.addEventListener('click', function () {
                ...
                setMaHD(maHD)
                setNgayNhan(moment(dshd[i].ngayNhanPhong).format('DD-MM-YYYY HH:mm:ss'))
                setNgayTra(moment(dshd[i].ngayTraPhong).format('DD-MM-YYYY HH:mm:ss'))
            ...
            btnCapNhat.addEventListener('click', async function () {
                ...
                setNgayLapHD(moment(res.data.ngayLapHD).format('DD-MM-YYYY HH:mm:ss'))
                setNgayNhan(moment(res.data.ngayNhanPhong).format('DD-MM-YYYY HH:mm:ss'))
                setNgayTra(moment(res.data.ngayTraPhong).format('DD-MM-YYYY HH:mm:ss'))
